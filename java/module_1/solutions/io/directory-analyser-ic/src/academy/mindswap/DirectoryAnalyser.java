...
public class DirectoryAnalyser {
    ...
    public void createFile() throws IOException {
        ...
        System.out.println(directory.getPath() + secondUserInput);
    ...
    public void filterFiles() throws IOException {
        ...
        File directory = askForDirectory();
        String userInput = getUserInput(Messages.FILTER_QUESTION);
        ...
        String[] filesFound = directory.list(new FilenameFilter() {
            @Override
            public boolean accept(File dir, String name) {
                return name.startsWith(userInput);
            }
        ...
        System.out.printf(Messages.FILES_FOUND, filesFound.length);
